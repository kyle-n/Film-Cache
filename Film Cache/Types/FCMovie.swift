...
struct FCMovie: Identifiable {
    ...
    func matches(query: String) -> Bool {
        ...
        return title.lowercased().trimmingCharacters(in: .whitespacesAndNewlines)
            .contains(normalizedQuery) || distributor.lowercased().trimmingCharacters(in: .whitespacesAndNewlines)
            .contains(normalizedQuery) || theaterName.lowercased().trimmingCharacters(in: .whitespacesAndNewlines)
